...
type Attachment struct {
	...
	Data        base64Binary `json:"base64binary,omitempty"`
	URL         string       `json:"url,omitempty"`
	Title       string       `json:"title"`
}

//TODO: Check BackboneElement if correct
type BackboneElement struct {
	Type       []CodeableConcept `json:"codeable_concept" bson:"codeable_concept"`
	Period     Period            `json:"period,omitempty"`
	Individual Person            `json:"person,omitempty"`
}
...
//Instant a string representation of a datetime to the second
type Instant string
...
type OperationOutcome struct {
	ResourceType string  `json:"resourceType" bson:"operation_outcome"`
	ID           string  `json:"id" bson:"id"`
	Issues       []Issue `json:"issue" bson:"issue"`
}
...
type SearchRequest struct {
	Method          Code    `bson:"method" json:"method"`
	URL             string  `bson:"url" json:"url"`
